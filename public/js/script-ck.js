...
(function(e){"use strict";e(".navigation ul.subMenu").hide();e(".navigation li.toggleSubMenu span").each(function(){e(this).replaceWith('<a href="" id="menu" title="Afficher le menu"><p id="cache">'+e(this).text()+"</p>"+"</a>")});e(".navigation li.toggleSubMenu > a").click(function(){if(e(this).next("ul.subMenu:visible").length!==0)e(this).next("ul.subMenu").slideUp("normal");else{e(".navigation ul.subMenu").slideUp("normal");e(this).next("ul.subMenu").slideDown("normal")}return!1})}).call(this,jQuery);